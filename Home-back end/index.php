                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        <h2>STEP INTO A NEW YEAR</h2>
                                        <h1>
                                            Get back in step for the school year ahead with your favorite sneakers.</h1>
                                        <div class="cr__btn">
                                ...
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product.php?id=<?php echo $list['Id']?>">
                                            <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['Image']?>" alt="Admin-products">
                                        </a>
                                    </div>
                                    ...
                                    <div class="fr__product__inner">
                                        ...
                                        <ul class="fr__pro__prize">
                                            <li class="old__prize"><?php echo $list['P_mrp'].' '.'tk'?></li>
                                            <li><?php echo $list['Selling_price'].' '.'tk'?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
